              ...
              {{-- <div class="testi_slider owl-carousel"> --}}
                  {{-- @for ($i = 0; $i < 10; $i++) --}}
                      {{-- <div class="item"> --}}
                        ...
                        {{-- <iframe width="30%" height="30%" src="https://www.youtube.com/embed/LPIdldqyfWI?rel=0;" frameborder="0" class="video-event"></iframe> --}}
                      {{-- </div> --}}
                  {{-- @endfor --}}
              {{-- </div> --}}
              <div class="welcome_img">
                <img class="img-fluid" src="/img/event/1.jpg" alt="">
            </div>
          </div>
          <div class="col-lg-6">
              <div class="testi_left_text_events no-margin-top">
                  <h4>#PEDULI SESAMA</h4>
                  <p>
      ...
      <div class="row testimonials_inner">
        <div class="col-lg-6">
          <div class="testi_left_text_events no-margin-top">
            ...
            <br><br>
            <p>
              Kini Yayasan Tangan Pengharapan, melalui donasi yang terkumpul dalam program <b>"Peduli Sesama"</b> dapat menyalurkan donasi minimal 500 paket sembako bagi masyarakat yang membutuhkan
              dan 350 paket nasi bungkus, sarung dan masker untuk mereka yang tunawisma setiap minggunya. 
              <br>
              Bantuan yang sudah disalurkan sebanyak 7.978 paket sembako kepada mereka yang berada di Jakarta, Depok, Bogor, tangerang, Bekasi, Nias, Mentawai, Jawa Tengah, Jawa Timur, 
              Kalimantan Barat & Tengah, Sulawesi Tengah, Sumba Barat & Timur, Timor NTT, Maluku Utara, Papua dan Papua Barat. 
              <br>
              Kami juga menyalurkan 2.475 paket nasi, sarung, lotion anti nyamuk dan masker bagi mereka yang tunawisma. 
              <br>
              Yayasan juga memberikan 490 bantuan tunai untuk membantu mereka yang rentan ekonominya, serta 1.512 APD ke 5 Rumah Sakit/Puskesmas.
              <br>
              Mari bersama-sama kita meringankan beban mereka untuk tetap bertahan di tengah pandemi ini. 
              <br>
              <br>
              <h3>Helping people live a better life!</h3>
            </p>
          </div>
        </div>
        <div class="col-lg-6">
